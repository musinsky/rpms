...
Name:       hunspell-ru
# package hunspell-ru in Fedora repo with Epoch 1
Epoch:      1
Version:    2025.05.22
Release:    1%{?dist}
Summary:    Russian hunspell multi dictionaries
...
# src0
iconv -f KOI8-R -t UTF8 src0/dictionaries/ru.aff --output=%{dict_path}/%{dict0_name}.aff
iconv -f KOI8-R -t UTF8 src0/dictionaries/ru.dic --output=%{dict_path}/%{dict0_name}.dic
sed -i 's/SET KOI8-R/SET UTF-8/' %{dict_path}/%{dict0_name}.aff
sed -i '1 i \# Firefox Russian spellchecking dictionary by Alexander Slovesnik' \
    %{dict_path}/%{dict0_name}.aff
sed -i '2 i \# ver 0.4.5.2resigned1 (released 2024-04-25, dictionary from 2013-06-29)\n' \
    %{dict_path}/%{dict0_name}.aff
touch -md "2013-06-29" %{dict_path}/%{dict0_name}.aff
touch -md "2013-06-29" %{dict_path}/%{dict0_name}.dic

# src1
dos2unix src1/dictionaries/ru_RU.aff
dos2unix src1/dictionaries/ru_RU.dic
cp src1/dictionaries/ru_RU.aff %{dict_path}/%{dict1_name}.aff
cp src1/dictionaries/ru_RU.dic %{dict_path}/%{dict1_name}.dic
sed -i '1 i \# Firefox Russian Hunspell dictionary by Aleksandr Klyukvin' \
    %{dict_path}/%{dict1_name}.aff
sed -i '2 i \# ver 1.0.20131101.3resigned1 (released 2024-04-25, dictionary from 2013-11-01)\n' \
    %{dict_path}/%{dict1_name}.aff
touch -md "2013-11-01" %{dict_path}/%{dict1_name}.aff
touch -md "2013-11-01" %{dict_path}/%{dict1_name}.dic

# src2
cp src2/dictionaries/ru_RU.aff %{dict_path}/%{dict2_name}.aff
cp src2/dictionaries/ru_RU.dic %{dict_path}/%{dict2_name}.dic
sed -i '1 i \# Firefox Slovar orfografii Wiki by Kek' %{dict_path}/%{dict2_name}.aff
sed -i '2 i \# ver 1.109 (released 2025-04-23)\n' %{dict_path}/%{dict2_name}.aff
# wrong DateTime in packed Firefox extension
touch -md "2025-04-23" %{dict_path}/%{dict2_name}.aff
touch -md "2025-04-23" %{dict_path}/%{dict2_name}.dic

%files
%{_datadir}/%{dict_dirname}/*

%changelog
* Thu May 22 2025 Jan Musinsky <musinsky@gmail.com> - 1:2025.05.22-1
- release 2025.05.22-1
