...
# 2026-04-21
# https://github.com/musinsky/rpms/blob/rawhide/hunspell-ru/hunspell-ru.create.SRPM.package.sh
...
GHC="https://raw.githubusercontent.com/musinsky/rpms/rawhide/hunspell-ru/"
FSPEC="hunspell-ru.spec"
