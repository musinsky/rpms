...
# 2026-04-21
# https://github.com/musinsky/rpms/blob/rawhide/hunspell-sk/hunspell-sk.create.SRPM.package.sh
...
GHC="https://raw.githubusercontent.com/musinsky/rpms/rawhide/hunspell-sk/"
FSPEC="hunspell-sk.spec"
